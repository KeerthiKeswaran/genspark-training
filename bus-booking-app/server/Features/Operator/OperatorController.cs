...
namespace server.Features.Operator
{
    ...
    public class OperatorController : ControllerBase
    {
        ...
        private readonly server.Core.Interfaces.INotificationService _notificationService;

        public OperatorController(AppDbContext context, server.Core.Interfaces.INotificationService notificationService)
        {
            _context = context;
