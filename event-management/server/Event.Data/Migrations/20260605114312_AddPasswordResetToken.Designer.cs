...
namespace Event.Data.Migrations
{
    ...
    [Migration("20260605114312_AddPasswordResetToken")]
            ...
            modelBuilder.Entity("Event.Models.Event", b =>
                {
                    ...
                    b.Property<string>("Secure_Scanner_Hash")
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)");
            ...
            modelBuilder.Entity("Event.Models.Transaction", b =>
                {
                    ...
                    b.Property<string>("Stripe_Receiver_Id")
                        .HasColumnType("text");

                    b.Property<string>("Stripe_Sender_Id")
                        .HasColumnType("text");
