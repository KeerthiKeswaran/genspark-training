...
namespace Event.Contracts.IServices
{
    public interface IPaymentService
    {
        ...
        Task<(bool Success, string SessionId, string SessionUrl, string ErrorMessage)> CreateCheckoutSessionAsync(decimal amount, string currency, string itemName, string successUrl, string cancelUrl);
    }
}
