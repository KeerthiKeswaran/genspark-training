...
namespace NotificationSystem.Presentation
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var repository = new NotificationRepository(configuration);
            ...
            void DisplayNotificationList(string title, List<Notification> notifications)
            {
                ...
                foreach (var n in notifications)
                {
                    ...
                    string contact = n is EmailNotification ? n.Sender.Email : n.Sender.PhoneNumber;
                    Console.WriteLine($"[{n.Id}] {type} ({contact}) | From: {n.Sender.Name} | To: {n.Receiver.Name} | Date: {n.SentDate}");
